...
let logger = winston.createLogger({
    transports: [
        new winston.transports.Console({
            level: process.env.LOG_LEVEL_WINSTON,  // need to set this in the .env not to be confused with WDIO LOG_LEVEL which is used in wdio.conf.ts
...
// export default so by impoeting logger we can use
